...
export const updateMode = (mode, scene, cloudMesh, horizonMesh, sceneUniforms) =>
{
    scene.background = sceneUniforms[mode].background;
    scene.fog = sceneUniforms[mode].fog;
    cloudMesh.visible = !!!mode;
    // horizonMesh.visible = !!!mode;
